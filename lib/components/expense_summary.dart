import 'package:expense_tracker_app/barGraph/bar_graph.dart';
...
class ExpenseSummary extends StatelessWidget {
  ...
  // calculate the max amount in the bar graph
  double calculateMax(
    ExpenseData value,
    String sunday,
    String monday,
    ...
    // and increase the cap slightly so the graph looks almost full but
    // not manually increase the height to avoid overflow.
    max = values.last * 1.1;

    return max == 0 ? 100 : max;
  }

  // calculate total expenses of a week
          ...
          SizedBox(
            ...
            child: BarGraph(
              maxY: calculateMax(
                  ...
                  thursday,
                  friday,
                  saturday), // --- maximum y value i.e. maximum daily expense ---
